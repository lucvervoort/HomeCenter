...
namespace MQTTnet.Extensions.ManagedClient
{
    public sealed class ManagedMqttClient : Disposable, IManagedMqttClient
    {
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::EnqueueAsync");
            ThrowIfDisposed();
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::StartAsync");
            ThrowIfDisposed();
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::StopAsync");
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::Dispose");
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::ReconnectIfRequiredAsync");

            if (InternalClient.IsConnected)
            {
                _logger.Verbose("<- ManagedMqttClient::ReconnectIfRequiredAsync (still connected)");
            ...
            try
            {
                ...
                {
                    _logger.Verbose("Trying to connect again...");
                ...
                {
                    _logger.Verbose("Reconnect success" + (connectResult.IsSessionPresent ? " (session present)" : " (reconnected)"));
                }
            ...
            catch (Exception exception)
            {
                ...
                _logger.Verbose("<- ManagedMqttClient::ReconnectIfRequiredAsync (not connected)");
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::StartPublishing");
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::StopMaintainingConnection");
        ...
        void StopPublishing()
        {
            _logger.Verbose("-> ManagedMqttClient::StopPublishing");
        ...
        {
            _logger.Verbose("-> ManagedMqttClient::TryMaintainConnectionAsync");
