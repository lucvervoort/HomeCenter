...
namespace HueApi.BridgeLocator
{
  ...
  {
    private static readonly Regex xmlResponseCheckHueRegex = new(@"Philips hue bridge", RegexOptions.IgnoreCase);
    private static readonly Regex xmlResponseSerialNumberRegex = new(@"<serialnumber>(.+?)</serialnumber>", RegexOptions.IgnoreCase);
