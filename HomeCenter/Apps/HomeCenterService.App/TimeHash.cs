...
namespace TimeHash
{
    ...
    public struct TimeHash
    {
        ...
        private static readonly Dictionary<string, int> DECODE_MAP = new();
        private static readonly Dictionary<string, Tuple<char, char>> NEIGHBOR_MAP = [];
        ...
        public static string Encode(double epochTime, int precision)
        {
            ...
            while (timeHash.Length < precision)
            {
                ...
                {
                    timeHash.Append(BASE32.AsSpan(ch, 1));
                    bit = 0;
                    ch = 0;
                }
            }
